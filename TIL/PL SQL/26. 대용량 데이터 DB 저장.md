...
public class StoreSaveHandler {  
        ...
        session.doWork(new Work() {  
            ...
            public void execute(Connection connection) throws SQLException {  
                ...
                try {  
                    ...
                    // OBJECT 타입 구조 생성  
                    StructDescriptor structDesc = StructDescriptor.createDescriptor("BETTER.R_STORE_INFO", oracleConnection);  
    ...
    private Object[] convertStoreInfoToOracleObjectArray(StoreInfo storeInfo) {  
        return new Object[]{  
                storeInfo.getStoreId(), storeInfo.getStoreName(), storeInfo.getBranchName(),  
                storeInfo.getCategoryLCode(), storeInfo.getCategoryLName(),  
                storeInfo.getCategoryMCode(), storeInfo.getCategoryMName(),  
                storeInfo.getCategorySCode(), storeInfo.getCategorySName(),  
                storeInfo.getIndustryCode(), storeInfo.getIndustryName(),  
                storeInfo.getSidoCode(), storeInfo.getSidoName(),  
                storeInfo.getSigunguCode(), storeInfo.getSigunguName(),  
                storeInfo.getAdminDongCode(), storeInfo.getAdminDongName(),  
                storeInfo.getLegalDongCode(), storeInfo.getLegalDongName(),  
                storeInfo.getJibunCode(), storeInfo.getLandDivCode(), storeInfo.getLandDivName(),  
                storeInfo.getJibunMainNo(), storeInfo.getJibunSubNo(), storeInfo.getJibunAddress(),  
                storeInfo.getRoadCode(), storeInfo.getRoadName(),  
                storeInfo.getBuildingMainNo(), storeInfo.getBuildingSubNo(),  
                storeInfo.getBuildingManageNo(), storeInfo.getBuildingName(), storeInfo.getRoadAddress(),  
                storeInfo.getOldZipCode(), storeInfo.getNewZipCode(),  
                storeInfo.getDongInfo(), storeInfo.getFloorInfo(), storeInfo.getUnitInfo(),  
                storeInfo.getLng(), storeInfo.getLat()  
        };  
    }  
}
```